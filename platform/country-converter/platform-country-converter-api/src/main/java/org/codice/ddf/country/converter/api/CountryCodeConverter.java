...
public interface CountryCodeConverter {
     ...
     * @param sourceFormat format of the country code that's being passed in.
     * @param desiredFormat format of the country code to convert into.
     * @return country code(s) in a List of string.
     */
    List<String> convert(@Nullable String countryCode, CountryCodeFormat sourceFormat,
